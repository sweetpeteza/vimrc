...
vim.keymap.set({ "n", "v" }, "<leader>tl", [["_d]])
...
vim.defer_fn(function()
    require('nvim-treesitter.configs').setup {
        ...
        ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'markdown', 'markdown_inline', 'vim', 'c_sharp' },
        ...
        highlight = {
            enable = true,
            additionial_vim_regex_highlighting = { "markdown" }
        },
        indent = { enable = true },
...
vim.keymap.set('n', '<leader>da', ":TestSuite<CR>")
vim.keymap.set('n', '<leader>dtl', ":TestLast<CR>")
vim.keymap.set('n', '<leader>dg', ":TestVisit<CR>")
